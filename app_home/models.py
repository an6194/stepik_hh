...
class Application(models.Model):
    written_username = models.CharField(max_length=120, verbose_name='Имя отправителя')
    written_phone = models.CharField(max_length=120, verbose_name='Телефон отправителя')
...
class Resume(models.Model):
    ...
    specialty = models.ForeignKey(Specialty, on_delete=models.CASCADE,
                                  related_name="resumes", verbose_name='Специальность')
